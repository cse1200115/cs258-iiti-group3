...
namespace Doctor_Window
{
    public partial class Doctor_frm : Form
    {
        ...
        private void richTextBox_rich_history_TextChanged(object sender, EventArgs e)
        {
        ...
        private void textBox_vpd_Y_of_joining_TextChanged(object sender, EventArgs e)
        {
